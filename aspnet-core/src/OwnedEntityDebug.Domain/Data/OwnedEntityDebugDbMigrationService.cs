...
{
    public class OwnedEntityDebugDbMigrationService : ITransientDependency
    {
        public ILogger<OwnedEntityDebugDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IOwnedEntityDebugDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public OwnedEntityDebugDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IOwnedEntityDebugDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<OwnedEntityDebugDbMigrationService>.Instance;
        }
